package it.gov.pagopa.analytics.ingestion.aspect;

import io.temporal.activity.Activity;
import io.temporal.activity.ActivityInfo;
import io.temporal.failure.ApplicationFailure;
import it.gov.pagopa.analytics.ingestion.exception.NotRetryableActivityException;
import it.gov.pagopa.analytics.ingestion.performancelogger.PerformanceLogger;
import it.gov.pagopa.analytics.ingestion.performancelogger.PerformanceLoggerThresholdLevels;
...
public class NotRetryableActivityExceptionHandlerAspect {
    ...
    @Pointcut("within(it.gov.pagopa.analytics.ingestion..activity..*)")
