package it.gov.pagopa.analytics.ingestion.config.json.jackson3;

import it.gov.pagopa.analytics.ingestion.config.json.LocalDateTimeToOffsetDateTimeDeserializer;
